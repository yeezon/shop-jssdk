...
var baseUrl = '../src/';
var docArray = [ 'util', 'shop', 'account', 'address', 'area', 'blog', 'cart', 'discount', 'coupon', 'option', 'order', 'page', 'payment_method', 'product', 'type', 'vendor', 'events', 'captcha', 'reward_point', 'page_block', 'post'];
var docExt = '.js';
